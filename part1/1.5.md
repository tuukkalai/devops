...
› d image pull devopsdockeruh/simple-web-service:ubuntu
...
› d image pull devopsdockeruh/simple-web-service:alpine
...
› d exec -it f332 sh -c 'cat text.log'
